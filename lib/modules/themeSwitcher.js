...
function themeSwitcher(){
    ...
    this.theme[sslStatus.insecureConnection] = new Theme('http','Insecure Connection Theme', data.url('img/insecureConnection.png'));
    this.theme[sslStatus.brokenCertificate]  = new Theme('https','Broken Certificate Theme', data.url('img/brokenCertificate.png'));
